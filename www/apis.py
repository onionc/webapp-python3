...
class Page(object):
    ...
    def __str__(self):
        return "item_count: {0}, page_count: {1}, page_index: {2}, page_size: {3}, offset: {4}, limit: {5}".format(self.item.count, self.page_count, self.page_index, self.page_size, self.offset, self.limit)
